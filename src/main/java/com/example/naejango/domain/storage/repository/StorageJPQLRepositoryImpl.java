...
public class StorageJPQLRepositoryImpl implements StorageJPQLRepository {
     ...
     */
    @Override
    public List<StorageNearbyInfo> findStorageNearby(Point point, int radius, int offset, int limit) {
        return em.createQuery("select new com.example.naejango.domain.storage.dto.response.StorageNearbyInfo" +
